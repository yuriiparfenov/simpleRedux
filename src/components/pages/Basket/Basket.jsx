    ...
    return(
        <div className={style["container-basket"]}>
            ...
            basketProducts.map((product, index) => {
                    return(
                        <section className={style["basket-item"]} key={product.id + ` ` + index}>
                            
                            <img src={product.img} alt="фото блюда" className={style["basket-item__img"]}/>
                            ...
                            <div className={style["basket-item__price-gramm"]}>
                                <span className={style["basket-price"]}>{product.price} ₽</span>
                            </div>
                            
                            <div 
                                key={product.uuid}
                                onClick={() => dispatch(deleteFromBasket(product.uuid))}
                                className={style["basket-item__icon-delete"]}></div>
                            </div>
                        </section>
                    )
            }) 
