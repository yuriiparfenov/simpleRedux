      ...
      <form className={formStyle['form']} method="post">
        ...
        <div className={formStyle['form__wrapper']}>
          <input
            ...
            name="email"
            className={
              formStyle['form__input'] + ' ' + formStyle['form__input-email']
            }
            placeholder="E-mail"
          />
          {emailDirty && emailError && (
            <span
              className={
                formStyle['form__error'] + ' ' + formStyle['form__email-error']
              }
            >
              {emailError}
            </span>
          ...
          <input
            ...
            name="password"
            className={
              formStyle['form__input'] + ' ' + formStyle['form__input-pass']
            }
            placeholder="Пароль"
          />
          {passDirty && passError && (
            <span
              className={
                formStyle['form__error'] +
                ' ' +
                formStyle['form__password-error']
              }
            >
              {passError}
            </span>
          ...
          <div className={formStyle['form__checkbox']}>
            <input
              ...
              name="inp_check"
              id="input-checkbox"
              className={formStyle['form__input-checkbox']}
            />
            <div className={formStyle['form__checkbox-mark']}></div>
            <label
              htmlFor="input-checkbox"
              className={formStyle['form__checkbox-label']}
            >
          ...
          {checkboxValue === false && (
            <span
              className={
                formStyle['form__error'] +
                ' ' +
                formStyle['form__checkbox-error']
              }
            >
        ...
        <Link to="/main">
          <button disabled={!formValid} className={formStyle['form__button']}>
            Войти
          </button>
        </Link>
      </form>
